...
import { applyAuthPersistence, authPersistence, onAuthStateChanged, registerWithEmail, signInWithEmail, signInWithGoogle, signOutFromFirebase } from "@/services/firebase/authService";
